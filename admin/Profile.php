    ...
    <section class="content">
		...
		<script type="text/javascript">
            ...
            <div class="widget-user-header bg-aqua-active">
              <h3 class="widget-user-username"><b><?php echo htmlspecialchars($admin->name); ?></b></h3>
              <h5 class="widget-user-desc"><?php echo htmlspecialchars($admin->email); ?> </h5>
            </div>
              ...
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php if(isset($admin->outlite)){echo htmlspecialchars(sizeof($admin->outlite));}else{echo "0";} ?></h5>
                    <span class="description-text">OUTLITE</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php if(isset($admin->product)){echo htmlspecialchars(sizeof($admin->product));}else{echo "0";} ?></h5>
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                    <h5 class="description-header"><?php if(isset($admin->sales)){echo htmlspecialchars(sizeof($admin->sales));}else{echo "0";} ?></h5>
					  ...
					  <div class="box-body">
						  ...
						  <form id="ChangeEmail_form" name="ChangeEmail_form" method="post" >
							  ...
							  <div class="box-body">
								  ...
								  <input id="ChangeEmail" name="ChangeEmail" type="email"  maxlength="50" minlength="6" required="required" class="form-control"   value="<?php echo htmlspecialchars($admin->email); ?>"/>
								</div>
