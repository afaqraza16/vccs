  ...
  <form>
    ...
    <div class="flex-parent-element">
      <div class="profile-block" class="flex-child-element my">
        <img src="../images/afaq.jpeg" alt="Profile Picture" class="profile-picture">
        ...
        <table>
          ...
          <tr>
            <td>Qualification:</td>
            <td rowspan="2">BS Computer Sciences AUP</td>
          </tr>
      ...
      <div class="profile-block" class="flex-child-element green">
        <img src="../images/shadab.jpeg" alt="Profile Picture" class="profile-picture">

        <table>
          <th colspan="2">Re-searcher</th>
          <tr>
            <td>Name:</td>
            <td>Malik Shadab Ahmad</td>
          </tr>
          <tr>
            <td>Role:</td>
            <td>Re-Searcher</td>
          ...
          <tr>
            <td>Qualification:</td>
            <td>BS Computer Sciences AUP</td>
          </tr>
      ...
      <div class="profile-block" class="flex-child-element my">
        <img src="../images/kamran.jpeg" alt="Profile Picture" class="profile-picture">
