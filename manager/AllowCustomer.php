  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<?php
			...
			$cust = array();
			if(isset($manager->outlite->deletedcustomer)){
				foreach($manager->outlite->deletedcustomer as $customers){
					$cust[] = $customers->id;
				}
			}
			...
			if(!in_array($_GET['id'], $cust)){
				...
				$customer_result = $customer->allowCustomer();
				
				if($customer_result == "success"){
					  
					  ?>
					<div class="error-page">
					<h2 class="headline text-green"><i class="fa fa-check text-green"></i></h2>
					<div class="error-content">
					  <h1><b> Customer Allowed Successfully.</b></h1>
					  <h4>
						Meanwhile, you may <a href="./Customer.php">return to Customer Summary</a>
					  </h4>
					</div>
				...
				<?php
					...
					<h2 class="headline text-green"><i class="fa fa-warning text-red"></i></h2>
					<div class="error-content">
					  <h1><b>Fail To Allow this Customer</b></h1>
					  <h4>
						Meanwhile, you may <a href="./Customer.php">return to Customer Summary</a>
					  </h4>
					</div>
